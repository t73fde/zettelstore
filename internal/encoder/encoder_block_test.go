...
|f1|>f2|=f3`,
		expect: expectMap{
			...
			encoderMD:    "| h1 | h2 | h3 |\n| --: | --- | :-: |\n| c1 | c2 | c3 |\n| f1 | f2 | =f3 |",
			encoderSz:    `(BLOCK (TABLE () ((CELL ((align . "right")) (TEXT "h1")) (CELL () (TEXT "h2")) (CELL ((align . "center")) (TEXT "h3"))) ((CELL ((align . "left")) (TEXT "c1")) (CELL () (TEXT "c2")) (CELL ((align . "center")) (TEXT "c3"))) ((CELL ((align . "right")) (TEXT "f1")) (CELL ((align . "right")) (TEXT "f2")) (CELL ((align . "center")) (TEXT "=f3")))))`,
