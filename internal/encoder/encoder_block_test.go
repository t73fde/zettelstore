...
var tcsBlock = []zmkTestCase{
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderMD:    "* A\n* B\n* C",
			encoderSz:    `(BLOCK (UNORDERED () (ITEM () (PARA (TEXT "A"))) (ITEM () (PARA (TEXT "B"))) (ITEM () (PARA (TEXT "C")))))`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderMD:    "* T1\n    1. T2\n* T3\n    * T4\n    * T5\n* T6",
			encoderSz:    `(BLOCK (UNORDERED () (ITEM () (PARA (TEXT "T1")) (ORDERED () (ITEM () (PARA (TEXT "T2"))))) (ITEM () (PARA (TEXT "T3")) (UNORDERED () (ITEM () (PARA (TEXT "T4"))) (ITEM () (PARA (TEXT "T5"))))) (ITEM () (PARA (TEXT "T6")))))`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderMD:    "* Item1.1\n* Item1.2\n* Item1.3\n* Item2.1\n* Item2.2",
			encoderSz:    `(BLOCK (UNORDERED () (ITEM () (PARA (TEXT "Item1.1"))) (ITEM () (PARA (TEXT "Item1.2"))) (ITEM () (PARA (TEXT "Item1.3"))) (ITEM () (PARA (TEXT "Item2.1"))) (ITEM () (PARA (TEXT "Item2.2")))))`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderMD:    "Text\n\n1. abc",
			encoderSz:    `(BLOCK (PARA (TEXT "Text")) (ORDERED () (ITEM () (PARA (TEXT "abc")))))`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderSz:    `(BLOCK (QUOTATION () (ITEM () (PARA (TEXT "ToBeOrNotToBe")))))`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderSz:    `(BLOCK (QUOTATION () (ITEM () (QUOTATION () (ITEM () (QUOTATION () (ITEM () (PARA (TEXT "foo") (SOFT) (TEXT "bar")))))))))`,
...
:::`,
	...
	},
	{
		...
		expect: expectMap{
			...
			encoderMD:    "|     |     |     |\n| --- | --- | --- |\n| c1 | c2 | c3 |\n| d1 |  | d3 |",
			encoderSz:    `(BLOCK (TABLE () () (ROW () (CELL () (TEXT "c1")) (CELL () (TEXT "c2")) (CELL () (TEXT "c3"))) (ROW () (CELL () (TEXT "d1")) (CELL ()) (CELL () (TEXT "d3")))))`,
...
|f1|>f2|=f3`,
		expect: expectMap{
			encoderHTML:  `<table><thead><tr><th class="right">h1</th><th>h2</th><th class="center">h3</th></tr></thead><tbody><tr><td class="left">c1</td><td>c2</td><td class="center">c3</td></tr><tr><td class="right">f1</td><td class="right">f2</td><td class="center">=f3</td></tr></tbody></table>`,
			encoderMD:    "| h1 | h2 | h3 |\n| --: | --- | :-: |\n| c1 | c2 | c3 |\n| f1 | f2 | =f3 |",
			encoderSz:    `(BLOCK (TABLE () (ROW () (CELL ((align . "right")) (TEXT "h1")) (CELL () (TEXT "h2")) (CELL ((align . "center")) (TEXT "h3"))) (ROW () (CELL ((align . "left")) (TEXT "c1")) (CELL () (TEXT "c2")) (CELL ((align . "center")) (TEXT "c3"))) (ROW () (CELL ((align . "right")) (TEXT "f1")) (CELL ((align . "right")) (TEXT "f2")) (CELL ((align . "center")) (TEXT "=f3")))))`,
			encoderSHTML: `((table (thead (tr (th ((class . "right")) "h1") (th "h2") (th ((class . "center")) "h3"))) (tbody (tr (td ((class . "left")) "c1") (td "c2") (td ((class . "center")) "c3")) (tr (td ((class . "right")) "f1") (td ((class . "right")) "f2") (td ((class . "center")) "=f3")))))`,
